      ...
      <style>
          ...
          #right {
            ...
            .left {
              ...
              background-color:#182858; color: white;
                padding: :20px;
 ...
 #button__
{
  ...
  <body>
      ...
      <section class="left" id = "l1" style="background-color:#182858; color: white; padding: 20px;">
...
$conn = new mysqli ($host,$dbusername,$dbpassword,$dbname);
      ...
      <section class="left" id = "l3">
         <div id = "ident" style="background-color:#182858; color: white; padding: 20px;"> add trainee</div>
...
<div class="btn-group">
  ...
  <div class="dropdown-menu">
    ...
    '.$row2['name'].'
      ...
      <section class="left" id ="l6" style="background-color:#182858; color: white; padding: 20px;">
